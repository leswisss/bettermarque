...
export const ProjectsContent = [
  {
    ...
    projectBrief: {
      ...
      briefText:
        "Engaging industry pioneers, government stakeholders, and visionary investors, ILID cultivates practical skills and mentorship opportunities. Participants develop scalable projects in energy, housing, and transport, fostering sustainable growth and community resilience across Cameroon.",
      projectSpecs: [
        {
          heading: "Type",
          text: "Branding",
