...
export const ProjectsContent = [
  {
    ...
    firstOtherDetail: {
      ...
      detailData: {
        ...
        secondaryText:
          "With a vibrant orange palette and SF Pro Display typography(one and only typography), we developed cohesive social templates, presentation decks, collateral, complete visual identity and a dynamic website. Custom icons and modular layouts reflect ILID’s forward-thinking vision, engaging STEM students and industry partners at every touchpoint.",
