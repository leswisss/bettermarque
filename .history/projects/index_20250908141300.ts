...
export const ProjectsContent = [
  {
    ...
    firstOtherDetail: {
      ...
      detailData: {
        mainText:
          "ikwe Estates needed a professional rebrand and modern website to replace informal broker imagery while clearly communicating trust, transparency, and affordability to customers and partners.",
        secondaryText:
