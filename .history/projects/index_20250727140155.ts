...
export const ProjectsContent = [
  {
    ...
    firstOtherDetail: {
      ...
      detailData: {
        ...
        secondaryText:
          "We designed a brandmark merging concentric rings representing the world, and three shapes pointing upward that stand for strong buildings and WBC's three main focuses: technical education, quality control, and hands-on training. We chose deep navy, bright blue, and teal paired with white, using Aventa Variable Regular, Medium and Semibold typefaces. This design appears on all materials from business cards, merchandise, signage, and presentation templates, creating a consistent, professional image.",
      },
    },
    preImages: [
      {
