...
export const ProjectsContent = [
  {
    ...
    firstOtherDetail: {
      ...
      detailData: {
        ...
        secondaryText:
          "We chose deep navy, bright blue, and teal paired with white, using Aventa Variable Regular, Medium and Semibold typefaces. This design appears on all materials from business cards, merchandise, signage, and presentations - creating a consistent, professional image.",
      },
    },
    preImages: [
      {
