...
export const ProjectsContent = [
  {
    ...
    firstOtherDetail: {
      ...
      detailData: {
        mainText:
          "We crafted an emblem blending a resilient tower silhouette with a luminous star, embodying ILID’s vision of lasting infrastructure and breakthrough innovation.",
        secondaryText:
