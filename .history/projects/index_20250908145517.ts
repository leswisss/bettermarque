...
export const ProjectsContent = [
  {
    ...
    secondOtherDetail: {
      ...
      detailData: {
        mainText:
          "A comprehensive ten-page bilingual website was delivered, featuring Home, About, Portfolio, Property Detail, Services, Blog, Blog Detail, Contact, Gallery, and Legal pages. The responsive, conversion-focused platform prioritizes lead generation through strategic user experience design.",
        secondaryText:
