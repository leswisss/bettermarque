...
export const ProjectsContent = [
  {
    ...
    firstOtherDetail: {
      ...
      detailData: {
        mainText: "DESIGN ATELIER STUDENTS PRIZE required comprehensive visual documentation to showcase the inaugural 2025 edition—capturing the rigor of jury deliberations, the energy of the awards ceremony, and the innovative spirit of 116 submitted projects from across Cameroon's architecture schools.",
      
      secondaryText: "Through meticulous cataloguing and design strategy, we developed a complete visual narrative documenting the competition journey from launch (December 16, 2024) through final awards (February 22, 2025). The catalogue architecture includes founder vision, jury profiles featuring leading architects like Danièle Diwouta-Kotto (ONAC 88) and Inno Chinje (ONAC 284), detailed project presentations of all 10 finalists with technical specifications, deliberation photography capturing authentic evaluation moments, ceremony documentation from Hôtel Albatros showcasing 200+ attendees, and partnership acknowledgments recognizing supporters like Saar Assurance, Dantela, and Global Engineering & Services. The bilingual publication employs a sophisticated editorial system with hierarchical project codes (DA_25_XXX), categorized sections spanning Education, Heritage & Culture, General Infrastructure, and Tourism, comprehensive technical sheets including SWOT analyses and construction details, and a complete appendix with evaluation criteria, registration forms, and copyright provisions. Design execution features structured typography for clarity across 105+ pages, strategic photography by Dany Beboua highlighting both intimate deliberation moments and celebratory ceremony energy, motion graphics and catalogue design by Bafri Schneider maintaining visual consistency, and a cohesive layout system balancing dense technical information with inspiring imagery of student innovation—from the winning École du Sahel project in Maroua to the Unveiled Heritage textile center in Douala."
  ...
  },
  {
    id: 7,
    projectBox: {
      name: "Pivot Engineering",
      slug: "pivot-engineering",
      year: 2025,
      slogan: "Building Smarter, Living Better",
    ...
    videoLink: "/videos/pivot.mp4",
    fallbackImage: PROJECT705,
    projectBrief: {
      mainText:
        "Pivot Engineering turns research into practice: applied research, sustainable construction solutions, engineering consultancy, construction management tools, and targeted training for resilient, low-carbon infrastructure.",
      briefText:
        "They convert scientific insight into locally-adapted materials and methods that reduce cost and carbon. Pivot delivers technical design, retrofitting and durability audits, transparent project controls, and practical training, equipping teams and clients to deliver efficient, sustainable projects that strengthen communities for the long term. They serve researchers, policymakers, developers, contractors and public agencies with evidence-based guidance to support informed decision-making.",
      projectSpecs: [
        {
          heading: "Type",
          text: "Branding",
    ...
    firstOtherDetail: {
      ...
      detailData: {
        mainText:
          "We designed an abstract spiral mark, three interlocking curved segments orbiting a central hub, symbolizing perpetual motion, continuous innovation, flexibility, and Pivot Engineering pivoting away from one-size-fits-all engineering practices to tailored, reliable solutions.",
        secondaryText:
          "The visual system pairs TT Norms Pro with a bold blue and vibrant yellow palette. We applied the identity across merchandise, banners, rollups, motion assets, business cards and other collateral to create a consistent, technical yet approachable presence that reflects Pivot’s research-led, sustainability-driven mission.",
      },
    },
    preImages: [
      {
        image: PROJECT701,
        aspectRatio: "2880/1950",
        alt: "Pivot Engineering",
      },
      {
        image: PROJECT702,
  ...
  },
  {
    ...
    projectBox: {
      ...
      slug: "ilid-2025",
      year: 2025,
      slogan: "Youth Building Resilient Communities through Infrastructure",
    ...
    videoLink: "/videos/ILID.mp4",
    fallbackImage: PROJECT505,
    projectBrief: {
      mainText:
        "Innovation Lab for Infrastructure Development (ILID) is one of Cameroon's premier platforms, empowering STEM students and young professionals to tackle infrastructure challenges through creative, sustainable solutions.",
      briefText:
        "Engaging industry pioneers, government stakeholders, and visionary investors, ILID cultivates practical skills and mentorship opportunities. Participants develop scalable projects in energy, housing, and transport, fostering sustainable growth and community resilience across Cameroon. With a strong focus on working together, being adaptable, and forward thinking, ILID aims to make bold ideas a reality.",
      projectSpecs: [
        {
          heading: "Type",
          text: "Branding",
    ...
    firstOtherDetail: {
      ...
      detailData: {
        mainText:
          "We crafted an emblem blending a resilient tower silhouette with a unique star, embodying ILID’s vision of lasting infrastructure and breakthrough innovation.",
        secondaryText:
          "With a vibrant orange palette and SF Pro Display typography(one and only typography), we developed cohesive social templates, presentation decks, collateral, complete visual identity and a dynamic website. Our custom icons and flexible layout showcase ILID's innovative spirit, attracting STEM students and industry partners on all platforms.",
    ...
    preImages: [
      {
        image: PROJECT501,
        aspectRatio: "3000/1862",
        alt: "Project ILID 2025",
      },
      {
        image: PROJECT502,
        aspectRatio: "3000/2150",
        alt: "Project ILID 2025",
      },
      {
        image: PROJECT503,
    ...
    preImages2: [
      ...
      {
        image: PROJECT517,
        aspectRatio: "3000/2298",
        alt: "Project ILID 2025",
      },
      {
        image: PROJECT518,
        aspectRatio: "3000/2160",
        alt: "Project ILID 2025",
      },
      {
        image: PROJECT519,
    ...
    preImages3: [
      {
        image: WEB501,
        aspectRatio: "5870/7208",
        alt: "Website ILID 2025",
      },
      {
        image: WEB502,
        aspectRatio: "4000/2358",
        alt: "Website ILID 2025",
      },
      {
        image: WEB503,
        aspectRatio: "4000/2749",
        alt: "Website ILID 2025",
      },
      {
        image: WEB504,
        aspectRatio: "4000/2863",
        alt: "Website ILID 2025",
      },
      {
        image: WEB505,
        aspectRatio: "4000/3533",
        alt: "Website ILID 2025",
      },
      {
        image: WEB507,
  ...
  },
  {
    ...
    detailsHeroContent: {
      ...
      herotext:
        "Brinovo Urbano is reshaping cities with sustainable design, transforming urban spaces into thriving ecosystems that balance innovation, functionality, and environmental harmony.",
      linkbutton: {
        text: "Read case study",
        color: "black",
      },
    ...
    projectBrief: {
      mainText:
        "Brinovo Urbano stands at the intersection of tradition and innovation, transforming urban landscapes through sustainable design.",
      briefText:
        "Emerging from a legacy of conventional architecture, the firm now envisions cities as dynamic ecosystems where functionality meets environmental harmony. Their mission is to redefine modern city planning by integrating eco-conscious principles into every project, ensuring that urban growth enriches communities while preserving nature’s integrity. Faced with this transformative journey, they sought a brand narrative that fully encapsulated their evolution and pioneering spirit.",
      projectSpecs: [
        {
          heading: "Type",
          text: "Rebranding",
    ...
    preImages: [
      {
        image: PROJECT115,
        aspectRatio: "3904/1952",
        alt: "Project Brinovo Urbano",
      },
      {
        image: PROJECT108,
        aspectRatio: "5500/3667",
        alt: "Project Brinovo Urbano",
      },
      {
        image: PROJECT125,
        aspectRatio: "3240/2010",
        alt: "Project Brinovo Urbano",
      },
    ],
    firstOtherDetail: {
      ...
      detailData: {
        mainText:
          "The Better Marque team crafted a comprehensive brand identity that breathes life into Brinovo Urbano’s vision.",
        secondaryText:
          "Our creative approach translated their commitment to sustainability into a visual language that fuses modern aesthetics with organic elements, evoking balance and innovation. This refreshed identity not only reinforces their leadership in sustainable urban design but also ignites meaningful dialogue among industry experts and community stakeholders, positioning Brinovo Urbano as a catalyst for the future of eco-conscious city transformation.",
        // link: "https://www.bettermarque.com"  // This is in case we have a project that has both brand identity and website development. This section will showcase the website link externally.
      },
    },
    preImages2: [
  ...
  },
  {
    ...
    projectBox: {
      ...
      year: 2024,
      slogan: "Reliable Infrastucture for Tomorrow's Progress",
      services: "Visual Identity - Video Production",
      coverImage: {
        image: PROJECT219,
    ...
    detailsHeroContent: {
      projectinfo: {
        name: "Ferrocore Construction",
        image: PROJECT2,
        aspectratio: "400/189.8621",
      },
      herotext:
        "Building the backbone of modern civilization, Ferrocore Construction delivers infrastructure that stands the test of time: strong, reliable, and built for progress.",
      linkbutton: {
        text: "Read case study",
        color: "black",
      },
    ...
    projectBrief: {
      mainText:
        "In today’s rapidly evolving landscape, infrastructure is more than just construction—it's the bedrock of progress.",
      briefText:
        "Ferrocore Construction recognized that their reputation for precision, reliability, and strength needed a powerful reflection in their brand. They sought a distinctive identity that would set them apart as leaders in commercial and industrial construction, appealing to both clients and investors. While a supporting short film was envisioned to further capture their story, the primary focus was on an impactful brand identity.",
      projectSpecs: [
        {
          heading: "Type",
          text: "Rebranding",
        ...
        {
          heading: "Services",
          text: "Visual Identity, Video Production",
        },
      ],
      liveLink: {
    ...
    firstOtherDetail: {
      ...
      detailData: {
        mainText:
          "Better Marque delivered a bold and refined brand identity that embodies Ferrocore’s core values of strength, trust, and innovation.",
        secondaryText:
          "Our approach integrated strategic design and clear messaging, transforming their visual presence into a symbol of enduring quality and progress. Although a compelling short film was also produced to complement this narrative, the cornerstone of the transformation was the comprehensive brand identity that now positions Ferrocore as an industry leader.",
        // link: "https://www.bettermarque.com"  // This is in case we have a project that has both brand identity and website development. This section will showcase the website link externally.
      },
    },
    preImages2: [
  ...
  },
  {
    ...
    projectBox: {
      ...
      year: 2024,
      slogan: "Luxury Properties Worthy of the Finest",
      services: "Brand Strategy - Visual Identity",
      coverImage: {
        image: PROJECT301,
    ...
    detailsHeroContent: {
      projectinfo: {
        name: "VossWalker Estates",
        image: PROJECT3,
        aspectratio: "197.8585/161.5119",
      },
      herotext:
        "Explore how Voss Walker Estates transforms luxury real estate into a realm of modern innovation and timeless elegance.",
      linkbutton: {
        text: "Read case study",
        color: "black",
      },
    ...
    projectBrief: {
      mainText:
        "Our challenge here was to develop a refreshed visual identity that embodies timeless elegance and the essence of luxury real estate.",
      briefText:
        "We were tasked with crafting a system that not only stands out in a competitive high-end market but also conveys the brand’s core values of trust, precision, and sophistication across every touchpoint.",
      projectSpecs: [
        {
          heading: "Type",
          text: "Rebranding",
    ...
    firstOtherDetail: {
      ...
      detailData: {
        mainText:
          "To capture the spirit of Voss Walker Estates, we created a versatile design system that fuses modern aesthetics with classic refinement. ",
        secondaryText:
          "By utilizing a curated color palette, refined typography, and clean layouts, we established a visual language that resonates with discerning clients, elevates brand perception, and sets a new standard in luxury real estate branding.",
        // link: "https://www.bettermarque.com"  // This is in case we have a project that has both brand identity and website development. This section will showcase the website link externally.
      },
    },
    preImages2: [
