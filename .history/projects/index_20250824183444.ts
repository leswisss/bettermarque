...
export const ProjectsContent = [
  {
    ...
    detailsHeroContent: {
      ...
      herotext:
        "Research-led and sustainability-driven, Pivot Engineering develops locally adapted construction methods and materials, delivering efficient, low-carbon infrastructure and capacity-building that future-proofs communities.",
      linkbutton: {
