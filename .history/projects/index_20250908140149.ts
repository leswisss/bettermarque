...
export const ProjectsContent = [
  {
    ...
    projectBrief: {
      ...
      briefText:
        "The company addresses common barriers such as lack of trust, perceived high costs, and complex processes, offering services like land sourcing & sales, real estate education and real estate development. With a vision to become the real estate company of preference by providing premium
services and opening doors to life-changing opportunities for millions of people in
Cameroon and beyond., PIKWE ESTATES targets young buyers, diaspora investors, and first-time landowners in a growing market.",
      projectSpecs: [
        {
          heading: "Type",
          text: "Branding",
