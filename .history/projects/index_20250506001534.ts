...
export const ProjectsContent = [
  {
    ...
    firstOtherDetail: {
      ...
      detailData: {
        mainText:
          "To shape an identity that embodies ILID's dedication to infrastructure development, we fused a tower sil with a radiant star, capturing the essence of enduring infrastructure and visionary progress.",
        secondaryText:
