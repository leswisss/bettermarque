...
export const ProjectsContent = [
  {
    ...
    firstOtherDetail: {
      ...
      detailData: {
        mainText:
          "The previous logo had two main problems. First, the gradient looked nice on screen but didn't work well in real world applications. Second, the text part looked too plain and didn't match the strength of the symbol.",
        secondaryText:
