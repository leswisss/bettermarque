...
export const ProjectsContent = [
  {
    ...
    detailsHeroContent: {
      ...
      herotext:
        "Research-led, nnovation focused and sustainability-driven, Pivot Engineering develops locally adapted construction methods and materials, delivering efficient, low-carbon infrastructure and training that strengthens communities.",
      linkbutton: {
