...
export const ProjectsContent = [
  {
    ...
    projectBrief: {
      mainText:
        "Pikwe Estates is a Cameroon-based real estate firm specializing in Real Estate Education, Land sourcing & sales, Real Estate Development. With a focus on transparency and community engagement, they guide first-time buyers and investors through every step of property ownership and development.",
      briefText:
