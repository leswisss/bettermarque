...
export const ProjectsContent = [
  {
    ...
    projectBrief: {
      ...
      briefText:
        "The company addresses common barriers such as lack of trust, perceived high costs, and complex processes, offering services like land sourcing & sales, buyer guidance, and marketing for real estate partners. With a vision to empower every Cameroonian to own land confidently, PIKWE ESTATES targets young buyers, diaspora investors, and first-time landowners in a growing market.",
      projectSpecs: [
        {
          heading: "Type",
          text: "Branding",
