...
export const ProjectsContent = [
  {
    ...
    detailsHeroContent: {
      ...
      herotext:
        "Showcasing the next generation of African architecture, Design Atelier Students Prize 2025 brings student projects from concept to public recognition and professional opportunity.",
      linkbutton: {
