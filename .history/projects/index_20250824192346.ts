...
export const ProjectsContent = [
  {
    ...
    firstOtherDetail: {
      ...
      detailData: {
        mainText:
          "We designed an abstract spiral mark, three interlocking curved segments orbiting a central hub—symbolizing perpetual motion, continuous innovation, flexibility, and Pivot’s break from one-size-fits-all engineering.",
        secondaryText:
