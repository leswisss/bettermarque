...
export const ProjectsContent = [
  {
    ...
    firstOtherDetail: {
      ...
      detailData: {
        ...
        secondaryText:
          "Concept One, the Shielded Plot, chosen. The central square represents stable, clearly defined land. Cornered outer-frame elements form structured boundaries; gaps in each corner act as entry points, suggesting access and opportunity. Palette: deep forest, mint, off-white, graphite.  Typography: Neue Montreal.",
