...
export const ProjectsContent = [
  {
    ...
    projectBrief: {
      mainText:
        "Pikwe Estates is a Cameroon-based real estate firm specializing in land sourcing sales, development and education. With a focus on transparency and community engagement, they guide first-time buyers and investors through every step of property ownership and development.",
      briefText:
