...
export const ProjectsContent = [
  {
    ...
    firstOtherDetail: {
      ...
      detailData: {
        mainText:
          "We designed a brandmark merging concentric rings representing the world, and three shapes pointing upward that stand for strong buildings and our three main focuses: technical education, quality control, and hands-on training.",
        secondaryText:
