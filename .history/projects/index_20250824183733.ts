...
export const ProjectsContent = [
  {
    ...
    detailsHeroContent: {
      ...
      herotext:
        "Research-led and sustainability-driven, Pivot Engineering uses research to create locally adapted construction methods and materials, delivering efficient, low-carbon infrastructure and training that strengthens communities.",
      linkbutton: {
