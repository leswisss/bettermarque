...
export const ProjectsContent = [
  {
    ...
    detailsHeroContent: {
      ...
      herotext:
        "Bridging academia and real-world impact, ILID cultivates student-led, sustainable infrastructure projects that strengthen Cameroon’s communities through creativity, collaboration, and resilience.",
      linkbutton: {
