...
export const ProjectsContent = [
  {
    ...
    projectBrief: {
      ...
      briefText:
        "Anchored by collaboration with government bodies, NGOs, and private partners, ILID cultivates practical skills and mentorship opportunities. Participants develop scalable projects in energy, housing, and transport, fostering sustainable growth and community resilience across Cameroon.",
      projectSpecs: [
        {
          heading: "Type",
          text: "Branding",
