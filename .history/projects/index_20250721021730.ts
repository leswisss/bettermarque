...
export const ProjectsContent = [
  {
    ...
    firstOtherDetail: {
      ...
      detailData: {
        ...
        secondaryText:
          "We use deep navy, bright blue, and teal colors on a white background, with Aventa Medium and Semibold fonts. You'll see this design on our business cards, merchandise, signs, and presentation slides - it gives WBC a professional look that reflects our focus on sustainability.",
      },
    },
    preImages: [
      {
