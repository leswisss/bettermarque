...
export const ProjectsContent = [
  {
    ...
    projectBrief: {
      ...
      briefText:
        "We thoroughly analyze each project, maintain strict quality standards, plan resources carefully, and provide hands-on construction oversight while training people in AutoCAD and Revit - ensuring projects are well-planned, properly built, and beneficial to communities long-term.",
      projectSpecs: [
        {
          heading: "Type",
          text: "Branding",
