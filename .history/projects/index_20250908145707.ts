...
export const ProjectsContent = [
  {
    ...
    secondOtherDetail: {
      ...
      detailData: {
        ...
        secondaryText:
          "The complete solution included custom UX wireframes, bilingual content strategy, and a robust CMS powering both blog and property management systems. Advanced filtering capabilities allow users to search by price, size, status, and location, while individual property pages showcase galleries, interactive maps, downloadable dossiers, and prominent inquiry calls-to-action. Lead capture mechanisms include secure contact forms, integrated WhatsApp functionality, consultant booking systems, and a downloadable land acquisition roadmap as the primary lead magnet. The platform was built with comprehensive SEO optimization, full accessibility compliance, and integrated analytics tracking. Final deliverables encompassed complete handoff assets including page templates, brand kit, and SVG files, plus thorough team training and documentation to ensure seamless ongoing management and measurable partner engagement.",
