...
export const ProjectsContent = [
  {
    ...
    projectBrief: {
      mainText:
        "Innovation Lab for Infrastructure Development (ILID) is one of Cameroon's premier events, empowering STEM students and young professionals to tackle infrastructure challenges through creative, sustainable solutions.",
      briefText:
