...
export const ProjectsContent = [
  {
    ...
    detailsHeroContent: {
      ...
      herotext:
        "From hands-on workshops to construction techniques, World Building & Consulting focuses on creating environmentally-friendly infrastructure that serves communities and gives students solid career preparation.",
      linkbutton: {
