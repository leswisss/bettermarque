...
export const ProjectsContent = [
  {
    ...
    firstOtherDetail: {
      ...
      detailData: {
        ...
        secondaryText:
          "Concept One: The Shielded Plot was selected as the final direction. The central square symbolizes stable, clearly defined land ownership, while the cornered outer-frame elements create structured boundaries that convey security and professionalism. Strategic gaps at each corner serve as entry points, subtly suggesting accessibility and opportunity for prospective clients. The sophisticated palette of deep forest, mint, off-white, and graphite reinforces trust and natural growth. Complete deliverables included vector logo files, complementary icon set, precise color specifications, comprehensive brand guidelines PDF, and Neue Montreal typography system for consistent application across all touchpoints.",
