...
export const ProjectsContent = [
  {
    ...
    firstOtherDetail: {
      ...
      detailData: {
        ...
        secondaryText:
          "We chose deep navy, bright blue, and teal paired with white, using Aventab regular, Medium and Semibold typefaces. This design appears on all our materials - business cards, merchandise, signage, and presentations - creating a consistent, professional image.",
      },
    },
    preImages: [
      {
