...
export const ProjectsContent = [
  {
    ...
    detailsHeroContent: {
      ...
      herotext:
        "From hands-on workshops to construction techniques, WBC focuses on creating environmentally-friendly infrastructure that serves communities and gives students solid career preparation.",
      linkbutton: {
    ...
    firstOtherDetail: {
      ...
      detailData: {
        mainText:
          "We designed a logo with circles representing the world, and three shapes pointing upward that stand for strong buildings and our three main focuses: technical education, quality control, and hands-on training.",
        secondaryText:
          "We used deep navy, bright blue, and teal colors on a white background, with Aventa Medium and Semibold fonts. You'll see this design on our business cards, merchandise, signs, and presentation slides - it gives WBC a professional look that reflects our focus on sustainability.",
      },
    },
    preImages: [
      {
