        ...
        <div className={styles.otherd__wrapper}>
          ...
          {content.headerButton === "Next Project" && content.projectDetails ? (
            <div className={styles.otherd__right2}>
              {
                content.projectDetails.link && <Link href={content.projectDetails.link} className={styles.otheri__container}>
              }
                <div className={styles.otheri__wrapper}>
                  {
                    content.projectDetails.image && content.projectDetails.name &&
                  <Image
                    fill
                    quality={100}
