...
const DetailsPageWrapper = () => {
  ...
  return (
    <>
      ...
      {
        currentProject.preImages3 && currentProject.secondOtherDetail && <OtherDetails content={currentProject.firstOtherDetail}/> <PreImages content={currentProject.preImages2}/>
      }
