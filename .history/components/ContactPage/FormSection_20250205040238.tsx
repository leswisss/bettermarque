...
const FormSection = ({ref}: {ref:  RefObject<HTMLDivElement | null>}) => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const companyname = formData.get("companyemail") as string | null;
    const companywebsite = formData.get("companyemail") as string | null;
    const projectscope = formData.get("companyemail") as string | null;
