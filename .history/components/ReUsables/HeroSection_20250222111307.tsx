    ...
    <section className={styles.hero__section}>
      <div className={`container ${styles.hero__container}`}>
        <div className={styles.hero__bottom}>
          <div className={`${styles.hb__left} ${animationFinished ? styles.button__visi : ""}`}>
            {pathname !== "/contact" && pathname !== "/projects" && !pathname.includes("/projects/") ? (
              <Button
          ...
          <div className={styles.hb__right}>
            ...
            <HeroTextMain maintext={content.herotext}  animationFinished={animationFinished}/>
          </div>
        </div>
      </div>
      {infinitemarquee && (
        <div className={`${styles.hero__marquee} ${animationFinished ? styles.active__marquee : ""}`}>
          <div className={`${styles.hero__marqueee}`}>
