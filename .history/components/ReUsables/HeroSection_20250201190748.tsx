      ...
      <div className={`container ${styles.hero__container}`}>
        <div className={styles.hero__bottom}>
          <div className={styles.hb__left}>
            <Button link={content.linkbutton.link} text={content.linkbutton.text} color={content.linkbutton.color}/>
          </div>
          <div className={styles.hb__right}>
            {content.buttonheadertext && <ButtonHeader text={content.buttonheadertext} />}
            {content.projectinfo <div className={styles.hero__project}>
              <div className={styles.project__image} style={{aspectRatio: "102.6/50"}}>
                <Image src={TESTIMAGE} fill quality={100} alt="Brinovo Urbano"/>
              </div>
