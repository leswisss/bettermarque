      ...
      >
        ...
        <div className={styles.content__wrapper}>
          <div className={styles.cw__top}>
            <div>
            <span className={styles.cw__name}>{content.name}</span><span className={styles.cw__line}>|</span><span className={styles.oc__slogan}>{content.slogan}</span>
            </div>
            <span>{content.name} | {content.slogan}</span>
          </div>
