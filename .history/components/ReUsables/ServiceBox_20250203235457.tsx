...
const ServiceBox = ({ content, serlength }: { content: ServiceProps, serlength: number }) => {
  //Parallax For Image
  ...
  return (
    <motion.div className={styles.servicebox} style={content.id !== ServicesData.length - 1 ? { y, zIndex: content.id + 1 } : { zIndex: i + 1 }}>
