...
const ServiceBox = ({
  ...
  const y1 = useTransform(scroll1, [0, 1], [transfrom, 0]);
  ...
  const y =
    content.id !== serlength
      ? useTransform(scroll2, [0, 1], [0, 250])
      : undefined;
      ...
      <div className={styles.sb__top} ref={ref}>
        <div className={styles.sbt__left}>
          <div className={styles.overflow}>
            <span style={{ transform: inView ? "translateY(0%)" : "translateY(100%)" }}>0{content.id}</span>
          </div>
        </div>
        <div className={styles.sbt__right}>
          <div className={styles.overflow}>
            <h1 style={{ transform: inView ? "translateY(0%)" : "translateY(100%)" }}>{content.name}</h1>
          </div>
        </div>
      </div>
        ...
        <div className={styles.sbb__right}>
          ...
          <div className={styles.sbb__bottom}>
            ...
            <div className={styles.details__cta}>
              <Button size="normal" link="/contact" color="black" text="Get in touch" />
            </div>
          </div>
        </div>
      </div>
