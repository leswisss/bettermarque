...
const GetinTouch = () => {
  const mainText = "Ready to take your project to the next level? 
Let’s collaborate to create the extraordinary. Share your project with us, and together, we’ll make it a reality."
  return (
