...
const ProjectBox = ({
  ...
  return (
    <>
      <Link
        href={
          !research ? `/projects/${content.slug}` : `/research/${content.slug}`
        }
        ...
        >
          <div className={styles.cw__top}>
            <div className={styles.cwtt}>
              <span className={styles.cw__name}>{content.name}</span>
              <span className={styles.cw__line}>|</span>
              <span className={styles.cw__slogan}>{content.slogan}</span>
            </div>
