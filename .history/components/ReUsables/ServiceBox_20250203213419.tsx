...
const ServiceBox = ({ content }: { content: ServiceProps }) => {
  const mainText =
    "Shape your brand's future with positioning that sets you apart, fosters creativity, and aligns seamlessly with your long-term goals while steering your business toward sustainable growth and success.";
