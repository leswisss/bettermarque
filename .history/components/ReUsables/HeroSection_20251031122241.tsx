        ...
        <div className={styles.hero__bottom}>
          ...
          <div className={styles.hb__right}>
            {content.buttonheadertext && (
              <ButtonHeaderMain text={content.buttonheadertext} animationFinished={animationFinished} />
            )}
            {content.projectinfo && (
              <div className={`${styles.hero__project} ${animationFinished ? styles.active__pro : ""}`}>
                <div
