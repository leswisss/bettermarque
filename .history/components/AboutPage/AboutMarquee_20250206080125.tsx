  ...
  useGSAP(() => {
    ...
    gsap.to(sliderRef.current, {
      scrollTrigger: {
        ...
        scrub: 1,
      onUpdate: (e) => {directionRef.current = e.direction * -1; rotationSpeedRef.current = e.direction * 2;} // Dynamically change rotation speed), // Update directionRef's current property
      },
      x: "-150px",
    });
    requestAnimationFrame(animation);
