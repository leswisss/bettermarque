...
const AboutMarquee = () => {
  ...
  // Explicitly type the array of refs to hold HTMLDivElement or null
  const imageWrappers = useRef<(HTMLDivElement | null)[]>([]); // Array to store refs of all image wrappers
