      ...
      <section className={`section ${styles.video__section}`}>
        <div className={`container ${styles.video__container}`}>
          <div className={styles.videoContainer} ref={containerRef}>
            ...
            />
            <div className={styles.playPauseButton} onClick={han}>
              <span onClick={togglePlay} className={styles.ppb__span}>{isPlaying ? <Icon icon="mdi:pause" /> : <Icon icon="mdi:play" />}</span>
            </div>
            <div
