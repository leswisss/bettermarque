...
const Navbar = ({animationFinished}: {animationFinished: boolean}) => {
  ...
  useGSAP(() => {
    ...
    if (navigation) {
      ScrollTrigger.create({
        ...
        scrub: 0.3,
        onEnter: () => {
          gsap.to(".nav__opacity", { opacity: 0, duration: 0.3 });
        },
        onLeaveBack: () => {
          gsap.to(".nav__opacity", { opacity: 1, duration: 0.3 });
        },
      });
    }
  }, { scope: navbar });
  ...
  return (
    <>
      <header className={`${styles.navigation} ${animationFinished ? styles.anim__finished : ""}`} ref={navbar}>
        <div className={`container ${styles.navigation__container}`}>
          <div className={styles.navigation__wrapper}>
            ...
            <div className={styles.nav__right}>
              <div className={`nav__opacity ${styles.nav__rightl}`}>
              ...
              <div className={styles.nav__rightr}>
                <div className={styles.rr__button}>
                  <Button
                    link="/contact"
