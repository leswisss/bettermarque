...
import { sideBarAnim, sideBarLinkAnim, sideNavAnim, sideBottomAnim } from "@/animations";
      ...
      <div className={styles.sidebar__wrapper}>
        <div className={`container ${styles.sidebar__container}`}>
          <div className={styles.sidebartop__wrapper}>
            <motion.div variants={sideBarLinkAnim}
                      initial="initial"
                      animate={activeSide ? "entry" : "initial"}
                      exit="exit" className={styles.sidebar__header}>
