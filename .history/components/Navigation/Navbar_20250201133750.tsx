    ...
    <header className={styles.navigation}>
      <div className={`container ${styles.navigation__container}`}>
        ...
        <div className={styles.nav__left}>
          {
            pathname==="/yu" ? <span className={styles.nav__agency}>Yaoundé Based Strategic<br />Branding Agency</span> : <Link href="/" className={styles.nav__image}>
              <Image fill quality={100} alt="BetterMarque Wordmark" src={WORDMARK}/>
            </Link>
          }
        </div>
