...
export const metadata: Metadata = {
  ...
  description: "Better Marque is a branding and design agency dedicated to creating impactful brands for Architects, Contractors, and Real estate professionals",
};
