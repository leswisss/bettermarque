...
export const metadata: Metadata = {
  ...
  description: "Better Marque is a branding and design agency dedicated to crafting impactful identit for Architects, Contractors, and Real Estate professionals",
};
